...
<div id="content">
    ...
    <div class="right">
        ...
        <div class="box taikhoan">
            <form action="?ctl=log" method="post">
                <div class="mb">
                    Tên đăng nhập <input type="text" name="user" required>
                </div>
                <div class="mb">
                    Mật khẩu <input type="password" name="pass"required >
                </div>
                <div style="color: red;"><?php if(isset($errors)){
                    echo $errors;
                } ?></div>
                <div class="mb">
